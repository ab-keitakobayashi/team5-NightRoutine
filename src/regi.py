...
def create_item(user: UserResiRequest, db_session: Session = Depends(get_db)):
    db_user = User(
        ...
        enemy_id=1,
        enemy_hp=100,
        ef_item_id_1=user.ef_item_id_1,
        ef_item_id_2=user.ef_item_id_2,
        ef_item_id_3=user.ef_item_id_3,
        ef_item_id_4=user.ef_item_id_4,
        ef_item_id_5=user.ef_item_id_5
    )
